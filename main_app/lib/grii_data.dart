...
class _TitleText extends Text {
  _TitleText(String text) : super(text, textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 32.0));
}
...
final pengakuanPenginjilan = [
  ...
  Text('Aku percaya Injil sebagai kuasa Allah untuk menyelamatkan setiap orang yang percaya.'),
  Text('Aku percaya satu Allah di dalam Tiga Pribadi, Pencipta manusia dan dunia, Hakim Tertinggi atas semua dosa dan Sumber keselamatan manusia.'),
  Text('Aku percaya kejatuhan manusia sebagai fakta sejarah yang menyebabkan polusi natur manusia secara total. Oleh sebab itu, manusia tidak mampu menyelamatkan dirinya sendiri.'),
  Text('Aku percaya anugerah Allah yang berdaulat kepada manusia yang tidak layak menerima keselamatan, yang memilih umat-Nya di dalam hikmat-Nya yang tertinggi oleh penetapan-Nya yang kekal, dan bertindak di dalam proses dinamis sejarah, untuk menebus mereka di dalam Anak Tunggal-Nya, Yesus Kristus.'),
  Text('Aku percaya akan inkarnasi Yesus Kristus melalui kelahiran anak dara, hidup-Nya tanpa dosa, penyaliban, kematian, kebangkitan dan kenaikan-Nya adalah fakta-fakta sejarah yang menyusun esensi dan berita Injil, sebagai satu-satunya sarana untuk mencapai keselamatan Allah.'),
  Text('Aku percaya kuasa darah Yesus Kristus yang membersihkan, terkandung di dalam pengorbanan-Nya yang bersifat penggantian, pemulihan (propisiasi), penebusan dan pendamaian, yang memberikan hidup baru kepada manusia.'),
  Text('Aku percaya akan pemberitaan Injil sebagai satu-satunya berita baik, yang memberikan dasar hidup bahagia dan pengharapan kekal bagi umat manusia. Penginjilan adalah:'),
  _BulletText('Kesaksian hidup orang-orang Kristen sejati yang menundukkan diri mereka kepada perintah Allah.'),
  _BulletText('Menciptakan pertemuan pribadi antara orang-orang berdosa dengan Allah, melalui perantaraan Yesus Kristus.'),
  ...
  Text('Aku percaya pertobatan sebagai bukti kelahiran baru dari Roh Kudus yang menghasilkan iman sejati di dalam Yesus Kristus dan menghasilkan buah-buah hidup baru.'),
  Text('Aku percaya akan pengurapan Roh Kudus di dalam penginjilan dalam bentuk keberanian, hikmat, kuat-kuasa, dan kesukaan menjadi saksi atas mereka yang mentaati Amanat Agung Yesus Kristus.'),
  Text('Aku percaya akan finalitas Injil yang adalah sempurna pada dirinya, yang tidak dapat digantikan atau dibandingkan, baik dengan pemikiran agama, ide filsafat, dan perbuatan baik duniawi (beda secara kualitatif), maupun dengan mandat kebudayaan dan kepedulian sosial di dalam iman ortodoks dan injili (hanya merupakan pelengkap dari pra- dan pasca-penginjilan), ataupun kariuna Roh Kudus dan mujizat dan tanda-tanda di dalam Alkitab (yang kadang-kadang Allah gunakan untuk menyaksikan Injil-Nya). Kita harus mempertahankan kesempurnaan Injil.'),
  Text('Aku percaya kuasa yang tidak berubah dari Injil Yesus Kristus yang mampu memelihara umat tebusan-Nya serta mengubah masyarakat melalui kesaksian mereka hingga hari penggenapan pemuliaan di saat kedatangan Yesus kembali.'),
];
